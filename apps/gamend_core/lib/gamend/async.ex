defmodule Gamend.Async do
  ...
  @supervisor Gamend.TaskSupervisor
  ...
  defp inline?, do: Application.get_env(:gamend_core, :async_inline, false)
      ...
      _pid ->
        case Task.Supervisor.start_child(@supervisor, wrapped) do
          ...
          {:error, :max_children} ->
            ...
            :telemetry.execute([:gamend, :async, :overload], %{count: 1}, %{})
