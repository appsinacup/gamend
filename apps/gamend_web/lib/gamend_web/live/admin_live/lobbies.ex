defmodule GamendWeb.AdminLive.Lobbies do
  ...
  def handle_event("create_lobby", %{"lobby" => params}, socket) do
    ...
    host_id = Gamend.UUIDv7.cast_or_nil(params["host_id"])
  ...
  def handle_event("add_member", _params, socket) do
    ...
    case Gamend.UUIDv7.cast_or_nil(socket.assigns.add_member_id) do
      nil ->
  ...
  defp lobby_members(lobby_id) do
    ...
    Gamend.Repo.all(from u in Gamend.Accounts.User, where: u.lobby_id == ^lobby_id)
  end
